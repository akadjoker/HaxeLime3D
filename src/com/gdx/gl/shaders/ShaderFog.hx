...
trace(vertexAttribute+","+colorAttribute+","+texCoord0Attribute );
	...
	override public function preSets():Void 
	{
			...
			GL.uniform3f(FogColor, color.r, color.g, color.b);
		    GL.uniform4f(FogInfos, Gdx.Instance().fogMode,Gdx.Instance().fogStart,Gdx.Instance().fogEnd,Gdx.Instance().fogDensity); 
