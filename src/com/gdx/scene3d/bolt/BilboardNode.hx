...
vertexbuffer.render(GL.TRIANGLES, numParticles * 6);
		...
		Gdx.Instance().numTris += numParticles * 2 ;
	         ...
	         GL.disableVertexAttribArray (vertexbuffer.pipeline.vertexAttribute);
 	        if(vertexbuffer.pipeline.texCoord0Attribute>=0) GL.disableVertexAttribArray (vertexbuffer.pipeline.texCoord0Attribute);
		    if (vertexbuffer.pipeline.colorAttribute >= 0) GL.disableVertexAttribArray (vertexbuffer.pipeline.colorAttribute);	
	  }
