...
constantUniform= GL.getUniformLocation (shaderProgram, "spotLight.pointLight.atten.constant");
linearUniform= GL.getUniformLocation (shaderProgram, "spotLight.pointLight.atten.linear");
exponentUniform = GL.getUniformLocation (shaderProgram, "spotLight.pointLight.atten.exponent");

//base
colorUniform = GL.getUniformLocation (shaderProgram, "spotLight.pointLight.base.color");
intensityUniform = GL.getUniformLocation (shaderProgram, "spotLight.pointLight.base.intensity");

positionLightUniform = GL.getUniformLocation (shaderProgram, "spotLight.pointLight.position");
rangeUniform = GL.getUniformLocation (shaderProgram, "spotLight.pointLight.range");
directionUniform = GL.getUniformLocation (shaderProgram, "spotLight.direction");
cutoffUniform= GL.getUniformLocation (shaderProgram, "spotLight.cutoff");
...
trace("ShaderSpotlight:",vertexAttribute+","+colorAttribute+","+texCoord0Attribute+","+normalAttribute );
    ...
    //atte
     ...
     GL.uniform1f(rangeUniform, range);
	     ...
	     GL.uniform1f(cutoffUniform, cutoff);
