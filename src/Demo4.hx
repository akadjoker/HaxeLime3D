...
/*
//var mesh = MeshCreator.loadStaticB3DMesh("data/model/city.b3d", "data/textures/");
var mesh = MeshCreator.loadStaticB3DMesh("data/model/city_small.b3d", "data/textures/");
mesh.CleanMesh();
mesh.Optimize();
...
player.setTexture(Gdx.Instance().getTexture("data/textures/body.jpg", true));
...
body.setTexture(Gdx.Instance().getTexture("data/textures/body.jpg", true));
...
gun.setTexture(Gdx.Instance().getTexture("data/textures/gun.jpg", true));

/**
        var barrel =  gun.getChildAt(0);
		scene.addSceneNode(MeshCreator.createCube(),barrel);
		
		var flash =  gun.getChildAt(1);
		scene.addSceneNode(MeshCreator.createCube(),flash);
		var weap =  gun.getChildAt(2);
		scene.addSceneNode(MeshCreator.createCube(),weap);
...
head.setTexture(Gdx.Instance().getTexture("data/textures/head.jpg", true));
...
//sprites.createSprite(new Vector3(0, 0, 0), 2, 1, 0, 5);
	...
	override public function render():Void 
	{
			...
			SceneManager.lines.lineVector(gunPosition, gunTarget, 1, 0, 0, 1);
