...
var scene:SceneManager;
	...
	terrain.loadTerrain("data/terra/terrain-heightmap.jpg", 100);
	terrain.setTexture(getTexture("data/terra/terrain-texture.jpg",true,false,true),0);
	terrain.setTexture(getTexture("data/terra/detailmap3.jpg", true,true,true),1);
	...
	*/
	...
	override public function render():Void 
	{
		 ...
		 for (i in 0 ... Std.int(vertives.length/3))
		{
		 ...
		 font.caption = Gdx.Instance().status+"\n\n GeoMipMap terrain (base from Irrlicht)" ;
